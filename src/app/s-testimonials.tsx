    ...
    return (
        <section id="testimonials" className="max-w-[1440px] mx-auto p-8 lg:p-0 mt-20 lg:mt-40 overflow-x-hidden">
            ...
            <article className="flex flex-col items-start justify-center">
                <h4 className="text-sm lg:text-base text-[#9E7A5F] text-start font-primary" data-aos="fade-right">Depoimentos</h4>
                <h1 className="text-black text-4xl lg:text-6xl max-w-[900px] font-primary" data-aos="fade-right" data-aos-delay="200">
