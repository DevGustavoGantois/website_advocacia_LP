                ...
                return (
                    <div key={index}>
                        <div className="flex flex-col justify-center items-center gap-4 lg:flex-row">
                            <div className="p-9 bg-gradient-to-b from-[#E3E3E3] to-[#FFFF] rounded-md" data-aos="fade-left">
                            ...
                            <div className="bg-gradient-to-b from-[#9E7A5F] to-[#563F2E] rounded-md relative" data-aos="fade-left" data-aos-delay="200">
                             <Image className="w-full h-full -z-10" src={item.imgBg} width={300} height={400} alt="" />
                            </div>
                            <div className="px-12 py-2 bg-gradient-to-r from-[#E3E3E3] to-[#FFFF] rounded-md" data-aos="fade-left" data-aos-delay="300">
